 ...
 */
public class GetReviewsResponseEvent {

    private GetReviewsResponse mNetworkResponse;
    private Integer httpStatusCode;


    public GetReviewsResponseEvent (GetReviewsResponse response){
        mNetworkResponse = response;
    }

    public GetReviewsResponse getNetworkResponse() {
